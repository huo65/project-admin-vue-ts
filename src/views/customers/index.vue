        ...
        >
          <template slot-scope="scope">
            <el-button type="text"
                       size="small"
                       class="blueBug"
                       @click="addCustomersHandle(scope.row.custname)"
            >
              修改
            </el-button>
            <el-button type="text"
...
import { deleteCustomers, getCustomersList } from '@/api/customers'
...
export default class extends Vue {
  ...
  // 添加
  private addCustomersHandle(st: string) {
    if (st === 'add') {
      this.$router.push({ path: '/customers/add' })
    } else {
      this.$router.push({ path: '/customers/add', query: { id: st } })
    }
  }
